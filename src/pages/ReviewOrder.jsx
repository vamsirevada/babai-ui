                        ...
                        {customerInfo.whatsappName}
														...
														<div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
																<div className="sm:col-span-1">
																		<label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2" htmlFor="site">
																				Select Site/Project *
																		</label>
																		<select
																				id="site"
																...
																<div className="sm:col-span-1">
																		<label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2" htmlFor="address">
																				Delivery Address *
																		</label>
																		<Input
																				id="address"
