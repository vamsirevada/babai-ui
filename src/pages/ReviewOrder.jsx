      ...
      try {
        ...
        if (uuid && reviewOrderRes) {
          if (reviewOrderRes.ok) {
            ...
            // If it's existing order data, populate the form
            if (reviewOrderData) {
              // You can extend this to populate form fields from existing order
              // setCustomerInfo(reviewOrderData.customerInfo || customerInfo)
              // setItems(reviewOrderData.items || items)
            }
          } else {
