    ...
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
        ...
        >
          ...
          <div className="flex justify-center mb-6 sm:mb-8">
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-2 sm:-top-4 -right-2 sm:-right-4 w-6 h-6 sm:w-8 sm:h-8 bg-gray-300 rounded-full opacity-30"></div>
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 w-4 h-4 sm:w-6 sm:h-6 bg-gray-400 rounded-full opacity-30"></div>
            </div>
          </div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight px-4 sm:px-0">
            ...
            <span
              className="bg-gray-600 bg-clip-text text-transparent ml-2 sm:ml-4 inline-block"
              style={{
                fontFamily: "'Dancing Script', 'Brush Script MT', cursive",
                fontWeight: '600',
                fontSize: '1.1em',
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 bg-white border border-gray-300 px-3 sm:px-4 py-2 rounded-full mb-4 sm:mb-6 shadow-sm">
            <svg
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight px-4 sm:px-0">
            ...
            <span className="text-gray-700 block mt-2 font-semibold">
          ...
          >
            <Badge className="bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-300 px-3 sm:px-4 py-2 shadow-sm hover:shadow-md transition-all duration-300 text-sm">
              Free to Start
            </Badge>
            <Badge className="bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-300 px-3 sm:px-4 py-2 shadow-sm hover:shadow-md transition-all duration-300 text-sm">
              Works on WhatsApp
