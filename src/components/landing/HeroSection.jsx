    ...
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 bg-white border border-slate-300 px-3 sm:px-4 py-2 rounded-full mb-4 sm:mb-6 shadow-sm">
            ...
            <span className="text-xs sm:text-sm font-medium text-slate-700 uppercase tracking-wider font-body">
              WhatsApp Construction AI Platform
            </span>
          </div>

          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold text-slate-800 mb-4 sm:mb-6 leading-tight px-4 sm:px-0 font-heading">
            Transform Your WhatsApp into{' '}
            <span className="text-blue-700 block mt-2 font-semibold">
              Smart Construction Brain
            </span>
          </h2>

          <p className="text-lg sm:text-xl text-slate-600 mb-6 sm:mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed px-4 sm:px-0 font-body">
          ...
          >
            <Badge className="bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 px-3 sm:px-4 py-2 shadow-sm hover:shadow-md transition-all duration-300 text-sm font-body">
              Free to Start
            </Badge>
            <Badge className="bg-slate-50 hover:bg-slate-100 text-slate-700 border border-slate-200 px-3 sm:px-4 py-2 shadow-sm hover:shadow-md transition-all duration-300 text-sm font-body">
              Works on WhatsApp
            </Badge>
            <Badge className="bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200 px-3 sm:px-4 py-2 shadow-sm hover:shadow-md transition-all duration-300 text-sm font-body">
              Easy to Learn
            </Badge>
          </div>
        </div>
      ...
      <div className="flex justify-center mt-12 sm:mt-16">
        <div className="flex flex-col items-center space-y-3 group cursor-pointer">
          {/* Simple text cue */}
          <span className="text-xs text-slate-400 uppercase tracking-wider font-medium group-hover:text-slate-600 transition-colors duration-300 font-body">
            Scroll below to know more
          </span>

          {/* Clean arrow */}
          <svg
            className="w-4 h-4 text-slate-300 group-hover:text-slate-500 group-hover:translate-y-1 transition-all duration-300"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          {/* Subtle line */}
          <div className="w-px h-8 bg-slate-200 opacity-60"></div>
        </div>
      </div>
    </div>
  )
