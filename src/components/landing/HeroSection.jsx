    ...
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
        ...
        >
          ...
          <div className="flex justify-center mb-6 sm:mb-8">
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-2 sm:-top-4 -right-2 sm:-right-4 w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full opacity-50"></div>
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 w-4 h-4 sm:w-6 sm:h-6 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full opacity-50"></div>
            </div>
          </div>

          {/* Hello Babai Text */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight px-4 sm:px-0">
            <span
            ...
            <span
              className="bg-gradient-primary bg-clip-text text-transparent ml-2 sm:ml-4 inline-block"
              style={{
                fontFamily: "'Dancing Script', 'Brush Script MT', cursive",
                fontWeight: '600',
                fontSize: '1.1em',
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 bg-gradient-warm px-3 sm:px-4 py-2 rounded-full mb-4 sm:mb-6">
            <svg
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight px-4 sm:px-0">
          ...
          >
            <Badge className="bg-gradient-whatsapp hover:bg-gradient-to-r hover:from-green-600 hover:to-emerald-700 text-white px-3 sm:px-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-sm">
              Free to Start
            </Badge>
            <Badge className="bg-gradient-primary hover:bg-gradient-to-r hover:from-blue-600 hover:to-indigo-700 text-white px-3 sm:px-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-sm">
              Works on WhatsApp
            </Badge>
            <Badge className="bg-gradient-accent hover:bg-gradient-to-r hover:from-purple-600 hover:to-violet-700 text-white px-3 sm:px-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-sm">
              Easy to Learn
            </Badge>
          </div>
        </div>
