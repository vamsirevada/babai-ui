...
const DemoSection = () => {
		...
		return (
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
								...
								<div className="text-center lg:text-left flex flex-col justify-center">
										...
										<div className="flex justify-center lg:justify-start mb-6">
												<div
														className="inline-flex items-center gap-2 bg-gradient-to-r from-functional-success/10 to-functional-success/5 border border-functional-success/30 px-3 py-1 rounded-full">
														<svg
                ...
                Live Demo
										...
										{/* Enhanced Heading */}
										<h3
												className="text-3xl md:text-4xl lg:text-5xl font-bold text-brand-charcoal mb-6 leading-tight font-heading">
            <span className="bg-gradient-to-r from-brand-primary to-brand-primary bg-clip-text text-transparent">
              Project Intelligence
                ...
                {' '}
												...
												<div
														className="bg-gradient-to-br from-brand-white via-brand-white to-brand-primary/5 border-2 border-brand-primary/30 rounded-2xl p-8 shadow-lg relative overflow-hidden">
														{/* Background decoration */}
														<div
																className="absolute inset-0 bg-gradient-to-r from-brand-primary/5 to-brand-primary/10 animate-pulse"></div>
                      ...
                      Get Started Instantly
																		...
																		<div className="space-y-4">
																				...
																				<div
																						className="inline-flex items-center gap-2 bg-white rounded-full px-6 py-3 shadow-md border border-green-200">
																						<svg
                        ...
                        Try bab.ai now
																				...
																				<div className="flex flex-wrap gap-2 justify-center">
																						<div
																								className="flex items-center gap-2 bg-white/80 border border-blue-200 px-3 py-1.5 rounded-full shadow-sm">
																								<svg
                          ...
                          Your Project
																						...
																						<div
																								className="flex items-center gap-2 bg-white/80 border border-green-200 px-3 py-1.5 rounded-full shadow-sm">
																								<svg
                          ...
                          Your WhatsApp
																						...
																						<div
																								className="flex items-center gap-2 bg-white/80 border border-purple-200 px-3 py-1.5 rounded-full shadow-sm">
																								<img
																										src="/brain.png"
																										alt="Brain"
                    ...
                    <span
		                    className="px-4 bg-gradient-to-r from-green-50 to-blue-50 text-green-700 font-medium rounded-full">
                      Real Impact
                    </span>
																		</div>
																</div>
																...
																<div className="grid grid-cols-2 gap-6">
																		<div className="text-center lg:text-left group">
																				<div className="flex items-center gap-3 mb-2">
																						<div
																								className="w-10 h-10 bg-white/80 border border-green-200 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-sm">
																								<svg
																										className="w-5 h-5 text-green-600"
																										viewBox="0 0 24 24"
																										fill="none"
																						...
																						<div>
																								<div
																										className="text-2xl lg:text-3xl font-bold text-green-600 group-hover:scale-110 transition-transform duration-300">
																										<AnimatedCounter
																												end={100}
																												suffix="K+"
																												duration={2000}
																		...
																		<div className="text-center lg:text-left group">
																				<div className="flex items-center gap-3 mb-2">
																						<div
																								className="w-10 h-10 bg-white/80 border border-blue-200 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-sm">
																								<svg
																										className="w-5 h-5 text-blue-600"
																										viewBox="0 0 24 24"
																										fill="none"
																						...
																						<div>
																								<div
																										className="text-2xl lg:text-3xl font-bold text-blue-600 group-hover:scale-110 transition-transform duration-300">
																										<AnimatedCounter
																												end={50}
																												suffix="K+"
																												duration={2300}
																		...
																		<div className="text-center lg:text-left group">
																				<div className="flex items-center gap-3 mb-2">
																						<div
																								className="w-10 h-10 bg-white/80 border border-purple-200 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-sm">
																								<svg
																						...
																						<div>
																								<div
																										className="text-2xl lg:text-3xl font-bold text-purple-600 group-hover:scale-110 transition-transform duration-300">
																										<AnimatedCounter
																												end={95}
																												suffix="%"
																												duration={2600}
																		...
																		<div className="text-center lg:text-left group">
																				<div className="flex items-center gap-3 mb-2">
																						<div
																								className="w-10 h-10 bg-white/80 border border-orange-200 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-sm">
																								<svg
																						...
																						<div>
																								<div
																										className="text-2xl lg:text-3xl font-bold text-orange-600 group-hover:scale-110 transition-transform duration-300">
																										<AnimatedCounter
																												end={2.5}
																												suffix="M"
																												duration={2900}
